...
export default function Todos() {
    ...
    let updateTodo = () => {
        setTodos((prevalue) => { return [...prevalue, { task: newTodo, id: uuidv4(), isDone: false }] });
        setNewTodo("");
    }
            ...
            <ul>
                {
                    todos.map((todo) => (
                        <li key={todo.id}>
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <span><button onClick={() => { uppercase(todo.id) }}>upeer case</button>&nbsp;&nbsp;</span>
                            <span><button onClick={() => { markDone(todo.id) }}>mark as done</button>&nbsp;&nbsp;</span>
